import 'package:bookapp_0505/data/data.dart';
import 'package:bookapp_0505/models/book_model.dart';
import 'package:bookapp_0505/models/single_book_model.dart';
import 'package:bookapp_0505/views/book_details.dart';
import 'package:flutter/material.dart';
import '../resource/widgets.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<SingleBookModel> singleBooks = new List<SingleBookModel>();
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return SingleBookTile(
                        title: singleBooks[index].title,
                        categorie: singleBooks[index].categorie,
                        imgAssetPath: singleBooks[index].imgAssetPath,
                      );
                    }),
              )
            ],
